...
const Header = () => (
  <header className="nx-header">
    <a href="#top" className="nx-header__brand">
      <img src={window.__resources.logo} alt="" className="nx-header__mark" />
...
const Hero = () => (
  <section className="nx-hero" data-screen-label="01 Hero">
    ...
    <img src={window.__resources.logo} alt="" className="nx-hero__seal" />
  ...
  <section className="nx-section nx-section--dark nx-about" data-screen-label="04 About">
    ...
    <div className="nx-about__inner">
      <div className="reveal reveal--scale">
        <FounderCard
          photoSrc={window.__resources.photo}
          nameJa="西岡 祐也"
...
const Footer = () => (
  <footer className="nx-footer" data-screen-label="10 Footer">
    <img src={window.__resources.logo} alt="" className="nx-footer__mark" />
